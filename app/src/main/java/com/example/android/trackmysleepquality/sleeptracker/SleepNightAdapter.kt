...
typealias SleepNightListener = (sleepId: Long) -> Unit
...
class SleepNightAdapter(private val clickListener: SleepNightListener) : ListAdapter<DataItem, RecyclerView.ViewHolder>(SleepNightDiffCallback()) {
    ...
    class ViewHolder private constructor(val binding: ListItemSleepNightBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(clickListener: SleepNightListener, item: SleepNight) {
            ...
            binding.root.setOnClickListener { clickListener(item.nightId) }
        }
    ...
    sealed class DataItem(val id: Long) {

        data class SleepNightItem(val sleepNight: SleepNight) : DataItem(sleepNight.nightId)

        object Header : DataItem(Long.MIN_VALUE)
    }
